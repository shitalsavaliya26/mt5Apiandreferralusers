...
class TotalBonusReportExport implements FromCollection, WithHeadings
{
    ...
    {
        // return TotalReport::all();
        
        $trading = TotalReport::select('*')->whereHas('users')->with('users');
        ...
        foreach ($collection as $key => $value) {
            ...
            unset($value['users'],$value['profit_date'],$value['created_at'],$value['updated_at']);
