...
class OwnershipBonusReportExport implements FromCollection, WithHeadings
{
    ...
    {
        // return OwnershipBonus::all();
        $trading = OwnershipBonus::select('*')->whereHas('users')->with('users');
