...
class LeadershipBonusReportExport implements FromCollection, WithHeadings
{
    ...
    {
        // return LeadershipBonus::all();
        $trading = LeadershipBonus::select('*')->whereHas('users')->with('users');
