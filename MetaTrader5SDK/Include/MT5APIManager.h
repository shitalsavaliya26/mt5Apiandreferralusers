...
//| Manager API version                                              |
//+------------------------------------------------------------------+
#define MTManagerAPIVersion  2361
#define MTManagerAPIDate     L"08 Mar 2020"
//+------------------------------------------------------------------+
//| Proxy description                                                |
//+------------------------------------------------------------------+
#pragma pack(push,1)
...
public:
   ...
   virtual MTAPIRES  PositionSplit(const UINT64* tickets,const UINT tickets_total,const double *adjustments,const UINT new_shares,const UINT old_shares,const UINT round_rule_price,const UINT round_rule_volume,const UINT clear_sltp,MTAPIRES* results)=0;
