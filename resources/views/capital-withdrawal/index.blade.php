            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <form id="example-form" class="cus-form-wizard" action="{{route('capital-withdrawal.store')}}" method="post" >
                    {{csrf_field()}}
                    <div>
                      ...
                      <section>
                        <div class="form-group">
                          ...
                          <select class="form-control" name="choose_trader" placeholder="Choose Trader" data-error="#err_trader" required onchange="caclulate($(this))">
                        ...
                        <div class="form-group">
                          ...
                          <input type="password" name="security_password" required id="security_password" class="form-control" data-error="#security_error" placeholder="@lang('capital_withdrawal.enter_security_password')">
