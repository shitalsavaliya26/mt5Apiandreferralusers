...
@section('title', 'ShareHolder Trading Profit')
...
<style>
    ...
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            @endif
            <h4 class="font-weight-bold">ShareHolder Trading Profit(10%)</h4>
            <br/>
            <div class="row ml-auto">
                <div class="col-md-12">
                    {!! Form::open(['route' => 'share-holder.profit','method'=>'get','id'=>'filter_data_ajax']) !!}
                        <div class="ml-2">
                            <div id="" class="input-group">
                                <div class="row col-lg-9 col-md-12 ml-auto search-field p-0">
                                    <div class="col-md-4 search-inpt">
                                        <input type="text" name="user_name"
                                               placeholder="@lang('general.search_name')"
                                    ...
                                    <div class="col-md-4 search-inpt">
                                        ...
                                        <input type="hidden" name="end_date" id="enddate" class="form-control" value="{{@$data['end_date']}}">
                                    ...
                                    <div class="row col-md-4 search-action">
                                        ...
                                        <a href="{{route('share-holder.profit')}}" class="btn-outline-twitter input-group-text" style="color:#2caae1;text-decoration:none;" onMouseOver="this.style.color='#ffffff'" onMouseOut="this.style.color='#2caae1'">
                                            Reset
                                        </a>
                                    </div>
                                </div>
