...
@section('content')
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="card">
                <div class="card-body">
                    {!! Form::model($share_holder,['route' => ['share-holder.update',$share_holder->id],'autocomplete'=>'false','files'=>true,'id'=>'share-form','method'=>'post']) !!}
                    @method('patch')
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" value="{{old('full_name',@$share_holder->name)}}" name="full_name"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row  mb-0">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" value="{{old('percent',@$share_holder->percent)}}" name="percent"
                                                   placeholder="ShareHolder Percent" step="0.1" min="0" max="{{$sharePercent}}" />
