                            ...
                            <div class="col-12 grid-margin">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="form-sample" method="post" id="rankForm"
                                              action="{{ route('ranks.update',['id' => $rank->id])}}">
                                            @csrf
                                            @method('PUT')

                                            <input type="hidden" value="{{$rank->id}}" name="rankId"/>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12"><!-- col-sm-9 to col-sm-12-->
                                                            <input type="text" value="{{old('name',$rank->name  )}}"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12"><!-- col-sm-9 to col-sm-12-->
                                                            <input type="text" class="form-control"
                                                                   value="{{old('direct_sale',$rank->direct_sale  )}}"
                                                                   name="direct_sale"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12"><!-- col-sm-9 to col-sm-12-->
                                                            <input type="text" class="form-control"
                                                                   name="downline_sales"
                                                                   value="{{old('downline_sales',$rank->downline_sales)}}"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control"
                                                                   value="{{old('direct_downline',$rank->direct_downline  )}}"
                                                                   name="direct_downline"
                                             ...
                                             <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="downline"
                                                                   value="{{old('downline',$rank->downline)}}"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="total_downline"
                                                                   value="{{old('total_downline',$rank->total_downline)}}"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="ownership_bonus"
                                                                   value="{{old('ownership_bonus',$rank->ownership_bonus)}}"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" name="unilevel"
                                                                   value="{{old('unilevel',$rank->unilevel)}}"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input type="text"
                                                                   value="{{old('leader_bonus',$rank->leader_bonus  )}}"
                                                                   name="leader_bonus" class="form-control"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input type="text"
                                                                   value="{{old('profit_sharing',$rank->profit_sharing  )}}"
                                                                   name="profit_sharing" class="form-control"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input type="text"
                                                                   value="{{old('trading_profit',$rank->trading_profit  )}}"
                                                                   name="trading_profit" class="form-control"
